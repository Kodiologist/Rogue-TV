...
(def-itemtype Item "aoy"
  :name (NounPhrase "Amulet of Yendor" :the-proper T)
  :char "☥"
  :color-bg :yellow
...
(def-itemtype Item "stormbringer"
  :name (NounPhrase "Stormbringer" :bare-proper T)
  :char ")"
  :color-fg :black
  :level-lo 14
  :unique T
  ...
  :applied (meth []
    (whenn (get-other-item @@ F "consume")
...
(def-itemtype Item "cyec"
  :name (NounPhrase "CYEC" :the-proper T)
  :char "("
  :level-lo 10
  :unique T
  :rarity :rare
